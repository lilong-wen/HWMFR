...
# from config import gpu, dictionaries
...
def for_test(x_t):
    ...
    encoder.load_state_dict(torch.load('../models/encoder_lr0.00010_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier.pkl'))
    # attn_decoder_lr0.00010_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier
    attn_decoder1.load_state_dict(torch.load('../models/attn_decoder_lr0.00010_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier.pkl'))
